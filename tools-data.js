...
const toolsData = [
    ...
    {
        id: 3,
        name: "Excel Merge Suite",
        category: "Excel Merge",
        description: "Excel Merge in one click.",
        ...
        badgeIcon: "🔥",
        badgeColor: "hot",
        features: ["Excel Merge", "Fix Formats", "Validation"],
        popular: false,
        showOnHome: true
    },
    {
        id: 4,
        name: "Email Automation Task Reminder",
        category: "Task Reminder Tools",
        description: "Send  bulk emails from outlook base for task tracking & reminder auto email send .",
        ...
        reviews: 94,
        badge: null,
        features: ["Bulk Task Email", "Task Tracking", "Due date Reminder"],
        popular: false,
        showOnHome: true
    },
    {
